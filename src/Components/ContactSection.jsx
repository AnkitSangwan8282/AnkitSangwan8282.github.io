...
export function ContactSection() {
  ...
  const handleOnSubmit = (e) => {
    ...
    emailjs.sendForm('service_1wvb0c5', 'template_eqo88ny', e.target, '1qRB7RXXGxCp3CRNn').then(
      (result) => {
    ...
    <div className={styles.rootCont} id="contact">
      ...
      <Form onSubmit={handleOnSubmit}>
        ...
        <div className={styles.iconsCont}>
          <a href="mailto:ankitsangwan8282@gmail.com">
            <AiOutlineMail className={styles.emailicon} />
          </a>
          <a
            href="https://www.linkedin.com/in/ankit-sangwan-86a8451b1"
            target="_blank"
            rel="noreferrer"
          >
            <AiFillLinkedin className={styles.linkedInIcon} />
          </a>
          <a href="https://github.com/AnkitSangwan8282" rel="noreferrer" target="_blank">
            <AiOutlineGithub className={styles.gitIcon} />
          </a>
        </div>
        <p className={styles.text}>Phone: +919971734534</p>{" "}
        <p className={styles.text}>Email: AnkitSangwan8282@gmail.com</p>
      </Fade>
    </div>
  )
}
