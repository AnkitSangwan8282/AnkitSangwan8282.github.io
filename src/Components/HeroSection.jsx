    ...
    <div className={styles.rootCont} id="hero">
      <Fade>
        <div className={styles.nameCont}>
          ...
          <a
            href="https://docs.google.com/document/d/1RTxjv7NX-9Dwtq41o8Pnn3Hh85lnkgHB/edit?usp=sharing&ouid=103255674204952899138&rtpof=true&sd=true"
            target="_blank"
        ...
        <div className={styles.socialCont}>
          ...
          <a
            rel="noreferrer"
            href="https://github.com/AnkitSangwan8282"
            className={classes.a}
            target="_blank"
          >
